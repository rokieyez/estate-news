...
- 보도 매체 1건: 한국경제
- 분류: 공급·정비사업, 청약·분양
* [한국경제 / 09-06 07:13] 9월 분양 물량 2만가구…청약 경쟁률 관건
...
- 보도 매체 1건: 매일경제
- 분류: 공급·정비사업, 지역이슈
* [매일경제 / 09-06 07:13] 강남 재건축 조합, 시공사 선정 난항
...
- 보도 매체 1건: 조선비즈
- 분류: 대출·금리
* [조선비즈 / 09-06 07:13] 주택담보대출 금리 다시 오름세…DSR 규제 영향
...
- 이미지 자리를 본문 흐름에 맞게 3곳 넣습니다. 형식은 정확히 이렇게 씁니다:
  `[이미지: 어떤 이미지를 넣을지 설명]`
  같은 순서로 image_slots 배열에 담되, 수치를 그림으로 보여주는 자리면 datapoint_label 에 그 수치의 label 을 그대로 적습니다.
